...
local blay = require "bling.layout"
...
awful.util.tagnames = { "term", "web", "code", "file", "games" }
...
nice {
  titlebar_color = beautiful.titlebar_color,
  ...
  close_color = "#f28fad",
  minimize_color = "#fae3b0",
  maximize_color = "#abe9b3",
  sticky_color = "#F8BD96",
  ontop_color = "#DDB6F2",
  floating_color = "#96CDFB",
}
...
awful.screen.connect_for_each_screen(function(s)
  ...
  freedesktop.desktop.add_icons {
    ...
    baseicons = {
      [1] = {
        label = "Home",
        icon = "/usr/share/icons/Papirus-Dark/48x48/places/user-home.svg",
        onclick = os.getenv "HOME",
      },
      [2] = {
        label = "Trash",
        icon = "/usr/share/icons/Papirus-Dark/48x48/places/user-trash.svg",
        onclick = string.format("%s/.local/share/Trash/files", os.getenv "HOME"),
      },
    },
  }
end)
...
globalkeys = mytable.join(
  ...
  end, { description = "open powermenu", group = "hotkeys" }),
  ...
  -- Show help
  awful.key({ modkey }, "F2", hotkeys_popup.show_help, { description = "show help", group = "awesome" }),
  ...
  awful.key({ modkey, altkey }, "e", awesome.quit, { description = "quit awesome", group = "awesome" }),
  ...
  awful.key({ "Shift" }, "XF86MonBrightnessUp", function()
    os.execute "light -A 50"
  end, { description = "+50%", group = "hotkeys" }),
  awful.key({ "Shift" }, "XF86MonBrightnessDown", function()
    os.execute "light -U 50"
  end, { description = "-50%", group = "hotkeys" }),
  ...
  awful.key({ modkey }, "w", function()
    awful.spawn(browser, { tag = mouse.screen.tags[2] })
