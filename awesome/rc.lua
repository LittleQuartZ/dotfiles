...
awful.spawn.with_shell(gfs.get_configuration_dir() .. "autostart")
...
awful.keyboard.append_global_keybindings {
  ...
  awful.key({ modkey, "Mod1" }, "e", awesome.quit, { description = "quit awesome", group = "awesome" }),
...
awful.keyboard.append_global_keybindings {
  ...
  awful.key({ modkey, "Control" }, "Tab", awful.tag.history.restore, { description = "go back", group = "tag" }),
}
...
awful.keyboard.append_global_keybindings {
  ...
  end, { description = "focus below", group = "client" }),
  awful.key({ modkey }, "k", function()
    awful.client.focus.bydirection "up"
  end, { description = "focus above", group = "client" }),
